              ...
              {!isMobile ? (
                ...
                >
                  ...
                  <p className="p-l-10per un-leash-paragraph text-left">
                    ...
                    empowers shipping companies to navigate these challenges
                    with confidence, providing a powerful suite of tools
                    designed to propel your fleet towards unparalleled
                  ...
                  <p className="p-l-10per un-leash-paragraph text-left">
                    ...
                    to make informed adjustments and course corrections,
                    ensuring optimal efficiency throughout your journey.
                  </p>
                </motion.div>
              ) : (
                <div>
          ...
          <Row style={{ margin: "0", padding: "0" }}>
            ...
            <Row className="m-l-0 m-r-0 p-l-0 p-r-0">
              <Col xs={12} className="p-l-0 p-r-0">
                <img
                  src="/Images/Mockups/fleet-dashboard-mockup-dashboard.jpg"
                  alt=""
                  className="img-fluid"
                />
              </Col>
                        ...
                        <Row className="CommonAccordion m-t-40">
                          <Accordion.Item eventKey="0" className=" mt-2 mb-2">
                            ...
                            <Accordion.Body>
                              <ul>
                                <li>
                                  Well scoped reports for all events at sea and
                                  at port.
                                </li>
                                <li>
                                ...
                                <li>
                                  {" "}
                                  Speed and consumption variance from CP.
                                </li>
                                <li>
                          ...
                          <Accordion.Item eventKey="4" className=" mt-2 mb-2">
                            ...
                            <Accordion.Body>
                              <ul>
                                ...
                                <li>
                                  Hull and propeller performance, degradation
                                  and resistance monitor.
                                </li>
                          ...
                          <Accordion.Item eventKey="13" className=" mt-2 mb-2">
                            ...
                            <Accordion.Body>
                              <ul>
                                <li>
                                  NAU system ensures continuous data recording
                                  and monitoring throughout the year, prior to
                                  submission, the data checks and issues are
                                  automatically highlighted on the NAU. These
                                  are automated checks applied on the submitted
                                  data per vessel and visible across the fleet.
                                  The checks support the users in detecting if
                                  any data might needs to be corrected. Incase
                                  no issues are detected the NAU automatically
                                  flows the data to the connected verifiers
                                  systems.
                                </li>
                              </ul>
                            </Accordion.Body>
                          ...
                          <Accordion.Item eventKey="9" className=" mt-2 mb-2">
                            ...
                            <Accordion.Body>
                              <ul>
                                ...
                                <li>
                                  AIS information integrated and customizable
                                  for different schedules for real time
                                  position.
                                </li>
                              </ul>
                            </Accordion.Body>
                          ...
                          <Accordion.Item eventKey="5" className=" mt-2 mb-2">
                            ...
                            <Accordion.Body>
                              <ul>
                                <li>
                                  Boiler consumption monitoring based on
                          ...
                          <Accordion.Item eventKey="11" className=" mt-2 mb-2">
                            ...
                            <Accordion.Body>
                              <ul>
                                <li>
                                  NAU is fully integrable with any Auto log or
                                  big data flow from various source systems:
                                  Vessel Design Data, Autolog Data, Noon Report
                                  Data and 3rd Party Data (AIS, Weather, etc.).
                                  These can feed data to the NAU system using
                                  API or other connectors enabling deeper
                          ...
                          <div className="layout11_item">
                            ...
                            <div className="layout11_content-wrapper">
                              ...
                              <p className="paragraph-11">
                                The rewards of adopting Orion's Fleet
                                Performance and Energy Efficiency Software are
                                multifaceted. Experience significant cost
                                savings through reduced fuel consumption, a
                                welcome benefit in today's volatile market.
                                Furthermore, Orion empowers you to become a
                                sustainability leader, minimizing your
                                environmental footprint and adhering to
                        ...
                        <div className="features-item-2">
                          <div className="layout11_item">
                            ...
                            <div className="layout11_content-wrapper">
                              ...
                              <p className="paragraph-11">
                                Transparency is key to achieving peak
                                performance. Orion equips you with a clear and
                                comprehensive picture of your fleet's
                                performance across all dimensions. Access
                                accurate and easy-to-understand reports that
                                empower data-driven decision-making. Identify
                                areas for improvement and capitalize on
                          ...
                          <div className="layout11_item">
                            ...
                            <div className="layout11_content-wrapper">
                              ...
                              <p className="paragraph-11">
                                ...
                                with features like IMO DCS and EU MRV support.
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="layout11_item">
                            ...
                            <div className="layout11_content-wrapper">
                              ...
                              <p className="paragraph-11">
                                ...
                                cleaner future. Orion empowers you to be a part
                                of the solution. Reduce emissions and achieve
                                significant cost savings through our fuel
                                consumption and emissions reporting features.
                                With Orion, you can contribute to a sustainable
                                future without sacrificing profitability.
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="layout11_item">
                            ...
                            <div className="layout11_content-wrapper">
                              ...
                              <p className="paragraph-11">
                                ...
                                fleet? Contact us today for a free demo and
                                discover how Orion's Fleet Performance and
                                Energy Efficiency Software can propel you
                                towards a future of unparalleled efficiency,
